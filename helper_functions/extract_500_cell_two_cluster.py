...
if __name__ == '__main__':
    ...
    k_cluster = 2
    df_name = 'pandas_dataframe_bcell_cd34cell_clusters_-1'
    fc_name = 'df_feature_column_bcell_cd34cell_clusters_-1'
    ...
    df_centroids.to_pickle('extract500_cell_results/ocmf_centroid_df')
    ...
    df_x_hat.to_pickle('extract500_cell_results/x_hat_df')
    
    
    df_final = pd.DataFrame(X, columns = pca_cols)
    df_final.to_pickle('extract500_cell_results/X_df')
    df_final['label'] = Y
    ...
    with open('extract500_cell_results/repre_size_count_Rr', 'wb') as f:
        pickle.dump(repre_size_count, f)
    with open('extract500_cell_results/cluster_size_count', 'wb') as f:
